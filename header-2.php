...
<div style="background-color: #C40504; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1);backdrop-filter: blur(10px); height: 85px; width: 100%">
    <a href="http://192.168.0.113/aeon/"><div style="background: url('http://localhost/hb/wp-content/uploads/screenshots/Logo-02%203.png'); width: 229px; height: 38px; position: relative; left: 12%; top: 24px">
    </div></a>
    <ul style="list-style: none; color: #FFF; display: flex; flex-direction: row; float: right; margin-right: 160px">
        ...
        <a href="<?php echo edd_get_checkout_uri(); ?>">
            <li style="background: url('http://192.168.0.113/hb/wp-content/uploads/screenshots/Cart.png'); width: 16px; height: 16px; margin-left: 50px; position: relative; top: 5px">
            </li>
        </a>
