...
<div style="display:flex; flex-direction: row; justify-content: space-around; padding-top: 40px">
    <?php ! $advanced_search ? get_sidebar(2) : ''; ?>
	<section id="primary" class="content-area<?php echo $advanced_search ? ' advanced-search-content' : ''; ?>" style="width: 60%; position: relative; left: 5%">
