    ...
    <div class="header-background">
        <div class="header-header">
            ...
            <ul>
                ...
                <li style="background: url('<?php echo(get_home_url() . '/wp-content/themes/vendd/screenshots/notifications_24px_outlined.svg')?>'); width: 24px; height: 24px; margin-left: 50px"></li>
                <a href="<?php echo edd_get_checkout_uri(); ?>">
                    <li style="background: url('<?php echo(get_home_url() . '/wp-content/themes/vendd/screenshots/Cart.png')?>'); width: 16px; height: 16px; margin-left: 50px"></li>
                </a>
            </ul>
        </div>
                    ...
                    <form role="search" method="get">
                        <div class="search-template">
                            ...
                            <button onclick="<?php echo esc_attr(get_search_query()); ?>">
                                ...
                                <img src="<?php echo(get_home_url() . '/wp-content/themes/vendd/screenshots/search.png')?>"
